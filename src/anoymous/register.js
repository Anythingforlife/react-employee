            ...
            <div className="col-sm-6 offset-sm-3">
              ...
              <Formik
                ...
                validationSchema={Yup.object().shape({
                  ...
                  password: Yup.string().required('The password field is required').min(5, 'The password field must be at least 5 characters.'),
                  confirmPassword: Yup.string().required('The confirmPassword field is required').min(5, 'The confirmPassword field must be at least 5 characters.').test('passwords-match', 'Passwords do not match', function (value) {
